//
// Created by bruce on 26.08.2020.
//
...
//
//    inline string read_word(){
//        string line;
//        list<string> words;
//        ifstream in("words.txt"); // окрываем файл для чтения
//        if (in.is_open())
//        {
...
//            }
//        }
//        for(auto word_it : words){
//            cout << word_it.data() << endl;
//        } ;
//
//
...
//    }
//
//    static inline list<string> read_words(){
//        string line;
//        list<string> words;
//        ifstream in("words.txt"); // окрываем файл для чтения
//        if (in.is_open())
...
//    }
//
//    int get_random_word(int min, int max)
//    {
...
//    string line;
//    list<string> words = Hangman::read_words();
//    ifstream in("words.txt"); // окрываем файл для чтения
//    if (in.is_open())
//    {
//        while (getline(in, line))
...
//    cout << "rand_value = " << 0 + rand() % words.size() << endl;
//    system("pause");
//
//    std::cout << "End of program" << std::endl;
}